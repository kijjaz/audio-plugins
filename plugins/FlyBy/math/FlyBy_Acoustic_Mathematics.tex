...
\begin{figure}[h]
\centering
\includegraphics[width=0.95\linewidth]{spatial_front_back_high_low_curves.png}
\caption{Measured frequency transfer functions $H(f)$ demonstrating front vs.\ back disambiguation (left: concha resonance vs.\ posterior pinna shadow) and vertical elevation cues (right: upward notch migration vs.\ torso comb reflection).}
\label{fig:front_back_curves}
\end{figure}
