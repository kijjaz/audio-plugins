...
\toprule
\textbf{Configuration} & \textbf{Azimuth} & \textbf{Elevation} & \textbf{ITD ($\mu$s)} & \textbf{ILD (dB)} & \textbf{Notch 1 (Hz)} & \textbf{Torso (dB)} \\
\midrule
Pure Horizontal Left  & $-90^\circ$ & $0^\circ$  & $+510.2$ & $-9.3$ & 7857 & $0.0$ \\
Center Horizon        & $0^\circ$   & $0^\circ$  & $0.0$    & $0.0$  & 7857 & $0.0$ \\
Pure Horizontal Right & $+90^\circ$ & $0^\circ$  & $-510.2$ & $+9.3$ & 7857 & $0.0$ \\
\midrule
Below Horizon (Nadir) & $0^\circ$   & $-40^\circ$ & $0.0$   & $0.0$  & 6371 & $-6.4$ \\
Eye-Level             & $0^\circ$   & $0^\circ$   & $0.0$   & $0.0$  & 7857 & $0.0$ \\
Zenith (Overhead)     & $0^\circ$   & $+90^\circ$ & $0.0$   & $0.0$  & 11200 & $0.0$ \\
\midrule
Combined 3D Swoop     & $+45^\circ$ & $+45^\circ$ & $-254.8$ & $+6.2$ & 9528 & $0.0$ \\
\bottomrule
\end{tabular}
\caption{Comparison of physical metrics across horizontal, vertical, and combined configurations.}
\label{tab:metrics}
\end{table}
